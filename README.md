...
Демонстрация основного пользовательского сценария: переход с главной страницы к анкете, формирование плана развития и работа с личным кабинетом.

<img src="assets/nextpath_demo.gif" alt="Демонстрация NextPath" width="100%">
